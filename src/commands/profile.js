  ...
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields(
        ...
        { name: '👛 👛 المحفظة', value: `$${(eco.wallet ?? 0).toLocaleString()}`, inline: true },
        { name: '🏦 🏦 البنك', value: `$${(eco.bank ?? 0).toLocaleString()}`, inline: true },
        { name: '💵 💵 صافي الثروة', value: `$${((eco.wallet ?? 0) + (eco.bank ?? 0)).toLocaleString()}`, inline: true },
